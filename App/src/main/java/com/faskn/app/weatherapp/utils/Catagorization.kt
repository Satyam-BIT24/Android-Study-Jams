...
class Catagorization(assetManager: AssetManager,modelPath: String,labelPath: String,inputSize: Int) {
    ...
    fun recognizeImage(bitmap: Bitmap):List<com.faskn.app.weatherapp.utils.Catagorization.Catagorization>{
    ...
    private fun getSortedResult(result: Array<FloatArray>): List<com.faskn.app.weatherapp.utils.Catagorization.Catagorization>{
        val pq=PriorityQueue(GREAT_OUTCOME_MXX,
            kotlin.Comparator<com.faskn.app.weatherapp.utils.Catagorization.Catagorization>{
        ...
        for(i in ROW_LINE.indices){
            ...
            if(confidence>=POINT_THRHLDO){
                pq.add(com.faskn.app.weatherapp.utils.Catagorization.Catagorization(""+i,if(ROW_LINE.size>i)ROW_LINE[i] else "Unknown",confidence))
            }
        }
        val recognitions=ArrayList<com.faskn.app.weatherapp.utils.Catagorization.Catagorization>()
